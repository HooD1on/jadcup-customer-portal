    ...
    <PageShell narrow>
      <div className="flex flex-col items-center justify-center py-16 text-center">
        <div className="w-16 h-16 rounded-full bg-jade-100 flex items-center justify-center mb-6">
          <Lock className="text-jade-600" size={28} />
        </div>
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Customer Login</h1>
        <p className="text-gray-500 max-w-sm mb-2">
          Login functionality is not yet available in this prototype.
        </p>
        <p className="text-sm text-gray-400 mb-8">
          Use the "Preview Customer Portal" link on the home page to view the authenticated experience.
        </p>
